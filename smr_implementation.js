...
debug('nsMsgSendListener.onStartSending: windowId='+this.windowId+' '+windows[this.windowId]);
console.debug('SMR: nsMsgSendListener.onStartSending: notify popup window');
console.debug('SMR: nsMsgSendListener.onStartSending: windowId='+this.windowId+' '+windows[this.windowId]);
...
debug('nsMsgSendListener.onStopSending windowId='+this.windowId+' '+windows[this.windowId]);
...
function debug(txt) {
	...
	if (prefs) {
		if (prefs.debug) {
			if (debugcache) {
        debugcache.split('\n').forEach(msg=>{ if (msg) console.log(msg)});
        debugcache='';
      }
